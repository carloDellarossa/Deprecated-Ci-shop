...
<!-- 			<div class="lista-filtros col col-xl-2 col-lg-2 col-md-2 col-sm-2"> 
					 <ul>
							 <?php foreach ($filtros as $filtro => $v){?>
									 	...
									 	<div role="tab" id="heading<?= $filtro ?>" >
										 <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?= $filtro ?>" aria-expanded="true" aria-controls="collapse<?= $filtro ?>">
											 <h3><?php	echo ucwords($filtro); ?></h3>
											</a>
										</div>

							 <ul style="max-height: 933px; overflow: auto">
								 <div id="collapse<?= $filtro ?>" class="collapse show" role="tabpanel" aria-labelledby="heading<?= $filtro ?>">
